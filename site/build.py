...
.grip i{{position:absolute;top:50%;left:0;transform:translate(-50%,-50%);width:40px;height:40px;border-radius:50%;background:#1c1c21;color:#fff;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 2px rgba(255,255,255,.85),0 6px 18px rgba(0,0,0,.28);font-style:normal;transition:transform .2s}}
.grip i svg{{width:18px;height:18px;display:block}}

...
@media (max-width:760px){{
  ...
  .tag{{top:14px;font-size:9px;letter-spacing:.2em;padding:5px 9px;border-radius:6px}}
  .tag.l{{left:14px}} .tag.r{{right:14px}} .tag b{{display:none}}
  .wordmark{{top:64px;font-size:21px}}
}}
